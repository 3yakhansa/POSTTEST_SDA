...
void preOrderTraversal(Node* root) {
     ...
     // Mengecek apakah node kosong, kalau iya langsung keluar dari fungsi
    if (root == nullptr) {
        return;
    }
     // Menampilkan data dari node saat ini (root dulu).
    cout << root->data << " ";  

    // Memanggil fungsi lagi untuk menelusuri subtree kiri dan kanan. 
